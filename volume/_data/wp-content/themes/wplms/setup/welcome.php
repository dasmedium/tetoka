			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="https://wplms.io/support/knowledge-base/3-4/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4>Course Application forms</h4>
						<p>Invite Application forms from Users for Course Enrollment.</p>
						<a href="https://wplms.io/support/knowledge-base/wplms-application-forms/" class="button"><?php _e( 'Check tutorial', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						...
						<p style="max-height: 320px; overflow: hidden;">
							<img src="http://wplms.io/demos/wp-content/uploads/2018/02/demo9-310x412.jpg">
						</p>
						<p>Available in demo switcher.</p>
						<a href="wplms.io/demos/demo9" class="button" target="_blank">Demo Link</a>
					</div>
					<div>
						<h4>Unit Timings AddOn</h4>
						<p style="max-height: 320px; overflow: hidden;">
							<img src="https://image.prntscr.com/image/LbXd5g2YQXOAKrl5moS8hA.png" >
						</p>
						<p>Record accurate user timings in courses, units.</p>
						<a href="https://wplms.io/downloads/wplms-unit-timings/" class="button" target="_blank">Purchase Link</a>
					</div>
					<div class="last-feature">
						<h4>Show Quiz results Right after completion</h4>
						<p style="max-height: 320px; overflow: hidden;"><img src="https://image.prntscr.com/image/WvNjIH_HQzWEAN4Qa8XotA.png" /></p>
						<a href="https://wplms.io/support/knowledge-base/show-quiz-results-right-after-quiz-completion" class="button">Tutorial</a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
